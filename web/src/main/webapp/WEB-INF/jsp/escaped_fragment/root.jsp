                ...
                <div class="popover right in fade show">
                    <div class="popover-inner">
                        ...
                        <div class="popover-content ng-scope" ng-if="!species.item">
                            ...
                            <!-- ngIf: species.family -->
                            <div ng-if="species.family" class="ng-binding ng-scope">
                                <strong class="ng-binding">Family:</strong> Brassicas -
                                <em class="ng-binding">Brassicaceae</em>
                            </div>
                            <!-- end ngIf: species.family -->


                            <!-- ngIf: species.rules.find('goodcompanion','category') != null -->
                    ...
                    Chard
                            ...
                            <!-- ngIf: species.rules.find('badcompanion','category') != null -->
                            <div ng-if="species.rules.find('badcompanion','category') != null" class="ng-scope">
                                <strong class="ng-binding">Bad companions: </strong>
                                <!-- ngRepeat: r in species.rules | filter:{category:'badcompanion'} --><span ng-repeat="r in species.rules | filter:{category:'badcompanion'}" class="ng-binding ng-scope">
                    Strawberry
                </span><!-- end ngRepeat: r in species.rules | filter:{category:'badcompanion'} -->
                            </div>
                            <!-- end ngIf: species.rules.find('badcompanion','category') != null -->
                            <!-- ngIf: species.rules.find('goodcroprotation','category') != null -->
                            <div ng-if="species.rules.find('goodcroprotation','category') != null" class="ng-scope">
                                <strong class="ng-binding">Good crop rotation: </strong>
                                <!-- ngRepeat: r in species.rules | filter:{category:'goodcroprotation'} --><span ng-repeat="r in species.rules | filter:{category:'goodcroprotation'}" class="ng-binding ng-scope">
                    Legumes
                </span><!-- end ngRepeat: r in species.rules | filter:{category:'goodcroprotation'} -->
                            </div>
                            <!-- end ngIf: species.rules.find('goodcroprotation','category') != null -->
                            <!-- ngIf: species.rules.find('badcroprotation','category') != null -->
                            <!-- ngIf: species.rules.find('speciesrepetition','category') != null -->
                            <div ng-if="species.rules.find('speciesrepetition','category') != null" class="ng-scope">
                                <strong class="ng-binding">Rotation interval: </strong>
                                <span class="ng-binding">Minimum 7 years</span>
                            </div>
                            <!-- end ngIf: species.rules.find('speciesrepetition','category') != null -->
                        </div>
